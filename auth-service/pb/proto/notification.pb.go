...
func (x *VerifyCodeResponse) GetIsValid() bool {
	if x != nil {
		return x.IsValid
	}
	return false
...
const file_proto_notification_proto_rawDesc = "" +
	...
	"\x12VerifyCodeResponse\x12\x19\n" +
	"\bis_valid\x18\x01 \x01(\bR\aisValid2\xd5\x01\n" +
	"\x13NotificationService\x12m\n" +
	"\x14SendVerificationCode\x12).notification.SendVerificationCodeRequest\x1a*.notification.SendVerificationCodeResponse\x12O\n" +
	"\n" +
	"VerifyCode\x12\x1f.notification.VerifyCodeRequest\x1a .notification.VerifyCodeResponseB\x10Z\x0epb/proto;protob\x06proto3"
...
var file_proto_notification_proto_goTypes = []any{
	...
	(*VerifyCodeRequest)(nil),            // 2: notification.VerifyCodeRequest
	(*VerifyCodeResponse)(nil),           // 3: notification.VerifyCodeResponse
}
var file_proto_notification_proto_depIdxs = []int32{
	...
	2, // 1: notification.NotificationService.VerifyCode:input_type -> notification.VerifyCodeRequest
	1, // 2: notification.NotificationService.SendVerificationCode:output_type -> notification.SendVerificationCodeResponse
	3, // 3: notification.NotificationService.VerifyCode:output_type -> notification.VerifyCodeResponse
